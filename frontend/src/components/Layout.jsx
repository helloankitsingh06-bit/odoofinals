...
export default function Layout({ children }) {
  ...
  return (
    <div className="flex bg-asset-dark text-asset-light min-h-screen font-sans">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Top Header Bar */}
        <header className="h-16 border-b border-stone-850 bg-stone-950/20 px-8 flex items-center justify-between">
